// Function to call the API to fetch data and display on the home page
...
// Rendering the characters list on the homepage
...
// Fetching the data through Marvel API, according to the input in the search bar and storing it in an Array arr.
...
// Collecting some elements in variables to handle press events
const searchbar = document.getElementById('name');
const ul = document.getElementById('ul');
const searchList = document.getElementById('search-list');
const notFound = document.getElementById('notFound');

// Handling Event when the user enters some input in the search field
...
// Append the searchList according to the data inserted in the search bar
function searchListFunc(data) {
    ...
    // Taking action on the favorite button
